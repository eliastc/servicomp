...
import com.mpinfo.servicosprof.dto.ClienteDTO;
import com.mpinfo.servicosprof.dto.ClienteNewDTO;
...
public class ClienteService {
	...
	public Cliente find(Integer id) {
		...
		return obj.orElseThrow(() -> new ExcessaoNaoEncontradaException(
	...
	// talves tambem tenha que acrescentar no ClienteDTO os campos endereco e
	...
	public Cliente fromDTO(ClienteDTO objDto) {
		return new Cliente(objDto.getId(), objDto.getNome(), null, objDto.getEmail(), null, null, null);
	}
	
	@Transactional
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), pe.encode(objDto.getSenha()), objDto.getEmail(), objDto.getCpfOuCnpj(), TipoClassificacao.toEnum(objDto.getClassificacao()), TipoCliente.toEnum(objDto.getTipo()));
